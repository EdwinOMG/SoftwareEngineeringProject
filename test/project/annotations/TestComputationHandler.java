...
public class TestComputationHandler { 
  private ComputationHandler computationHandler;
   ...
   @Test public void testComputationHandlerExist() { 
      assertNotNull("ComputationHandler should be living!"); 
    }
   // it mocks input output configuration and then calls our compute method // with a request, which should be a success(api can process request) 
   @Test 
